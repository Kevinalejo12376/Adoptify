  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="px-3 sm:px-4 py-2">
              {topicsLoading ? (
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-sm text-gray-500">Aún no hay temas en el foro</p>
                </div>
              ) : (
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="back-to-top fixed bottom-24 right-5 w-14 h-14 bg-gradient-to-r from-rose-500 to-amber-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50 flex items-center justify-center"
